    ...
    <article className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition flex flex-col justify-between">
      <div>
        <div className="relative aspect-[4/3] sm:aspect-auto">
          ...
          />}
          <span
            className={`absolute top-2.5 left-2.5 sm:top-3 sm:left-3 text-white text-[10px] sm:text-[11px] font-bold px-2 py-0.5 sm:px-2.5 sm:py-1 rounded-md ${
          ...
          <button
            ...
            className="absolute top-2.5 right-2.5 sm:top-3 sm:right-3 bg-white/90 p-1.5 rounded-full text-gray-600 hover:text-red-500 transition"
          >
          ...
          <button
            ...
            className="absolute top-2.5 right-10 sm:top-3 sm:right-12 bg-white/90 p-1.5 rounded-full text-gray-600 hover:text-[#00875A] transition"
          >
        ...
        <div className="p-3 sm:p-4">
          ...
          <div className="flex items-center justify-between gap-2">
            <div>
              <span className="text-[9px] sm:text-[10px] text-gray-400 block leading-none mb-0.5">মোট মূল্য</span>
              <span className="text-sm sm:text-base font-extrabold text-[#00875A]">{property.formattedPrice}</span>
            </div>
          ...
          <p className="text-[9px] sm:text-[10px] text-[#00875A] font-semibold mt-1 sm:mt-2">আলোচনা সাপেক্ষ</p>
      ...
      <div className="px-3 pb-3 sm:px-4 sm:pb-4 pt-0">
        <button
          ...
          className="w-full bg-gray-900 text-white text-[11px] sm:text-xs font-semibold py-2 sm:py-2.5 rounded-lg hover:bg-gray-700 transition flex items-center justify-center gap-1"
        >
          বিস্তারিত দেখুন <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
        </button>
      </div>
    </article>
  );
